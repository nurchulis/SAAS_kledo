...
const routes = [
  {
    path: '/bookings',
    component: loadable(() => import('pages/bookings')),
    exact: true,
  },

  {
    path: '/rates',
    component: loadable(() => import('pages/rates')),
    exact: true,
  },

  {
    path: '/rooms',
    component: loadable(() => import('pages/rooms')),
    exact: true,
  },

  {
    path: '/channels',
    component: loadable(() => import('pages/channels')),
    exact: true,
  },
  {
    path: '/edit_payment',
  ...
  {
    path: '/guests',
    component: loadable(() => import('pages/guests')),
    exact: true,
  },
